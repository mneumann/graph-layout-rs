...
impl<'a> SvgWriter<'a> {
    ...
    pub fn edge(&mut self, pos1: &P2d, pos2: &P2d, directed: bool) {
        ...
        writeln!(&mut self.wr, r#"<path d="M{} {} L{} {} L{} {}" stroke="{}" stroke-width="{}px" {}/>"#,
                 x1, y1, mx, my, x2, y2, self.canvas.stroke_color, self.canvas.stroke_width, marker).unwrap();
    }

    pub fn draw_graph(mut self, node_positions: &Vec<P2d>, node_neighbors: &Vec<Vec<usize>>, directed: bool) {
        self.header();
